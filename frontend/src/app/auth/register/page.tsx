...
import { Compass, Mail, Lock, User, Globe } from 'lucide-react';
        ...
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <Input
                placeholder={t('auth.nationality')}
                value={nationality}
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-dark-main text-gray-500">{t('auth.social_login')}</span>
              </div>
            </div>
